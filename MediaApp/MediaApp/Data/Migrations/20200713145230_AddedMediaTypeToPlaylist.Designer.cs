...
namespace MediaApp.Data.Migrations
{
    ...
    [Migration("20200713145230_AddedMediaTypeToPlaylist")]
    partial class AddedMediaTypeToPlaylist
    {
            ...
            modelBuilder.Entity("MediaApp.Domain.User", b =>
                {
                    ...
                    b.Property<int>("BookmarkedMusicId")
                        .HasColumnType("int");

                    b.Property<int>("BookmarkedPodcastId")
                        .HasColumnType("int");

                    b.Property<int>("BookmarkedSeriesId")
                        .HasColumnType("int");
